function [descs,pattern] = microtDescs2(feature, featureFs,  beats, wavFilename, metLevel);
%
% function [mtdescs,pattern] = microtDescs2(feature, featureFs, beats, wavFilename, metLevel);
%
% compute micro-timing features - but assume a 2 beat window so make normalised beat size twice as big
%
